...
<?php
    ...
    $stmtErr = $stmt->execute(['p_id' => $_COOKIE['changed_uid'], 'name' => filter_input_html($_POST['name']),'mail' => filter_input_html($_POST['email']) , 'year' => filter_input_html($_POST['year']), 'gender' => filter_input_html($_POST['gender']), 'limbs_num' => filter_input_html($_POST['limbs']), 'biography' => filter_input_html($_POST['biography']), 'p_login' => filter_input_html($_POST['p_login']), 'p_pass' => filter_input_html(hash("adler32",$_POST['p_pass']))]);
